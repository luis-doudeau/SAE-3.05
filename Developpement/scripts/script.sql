...
MAISON_EDITION, LIEU, INTERVENTION, HOTEL, CRENEAU, CRENEAURESTAU, CRENEAUTRAVAIL, RESTAURANT, SECRETAIRE, UTILISATEUR;
...
CREATE TABLE REPAS (
  ...
  FOREIGN KEY(idCreneau) REFERENCES CRENEAURESTAU(idCreneau)
) ENGINE=InnoDB DEFAULT CHARSET=UTF8MB4;
